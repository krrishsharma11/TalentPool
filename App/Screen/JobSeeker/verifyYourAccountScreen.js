...
const VerifyYourAccountScreen = ({ route, navigation }) => {
      ...
      <View style={styles.otpmainView}>
        ...
        <View style={styles.mobileView}>
          <View style={styles.innerContainer}>
            <View style={styles.row}>
              <Svg.MobileIcon />
              <Text style={styles.numberStyle}>{phone}</Text>
              <TouchableOpacity>
                <Svg.Edit />
              </TouchableOpacity>
            </View>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('phoneVerification', { phone: phone })}
            >
        ...
        <View style={styles.mobileView}>
          <View style={styles.innerContainer}>
            <View style={styles.row}>
              <Svg.MailIcon />
              <Text style={styles.numberStyle}>{email}</Text>
              <TouchableOpacity>
                <Svg.Edit />
              </TouchableOpacity>
            </View>
